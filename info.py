...
# Bot information
API_ID = environ.get('API_ID', '26395468')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '26395468') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1740849725') #apni tg id daalo
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002497597012') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001874080473') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://User:user1@cluster0.twl38.mongodb.net/") #mongo db url
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002416969702") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "mid-clarie-ajb-8173861c.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
